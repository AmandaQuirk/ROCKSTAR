...
for i in range(len(mass)): #below narrows down which ROCKSTAR halos are plotted
        ...
        if Mc != mass[i] and (Mc*0.01)<mass[i] and 800>r: #(Mc/400)<mass[i] and  
...
pygad.plotting.image(s.stars, qty='mass', cmap='BlackBlue', showcbar=False, cbartitle='Stars', fontcolor='w', fontsize=10, extent='300 kpc', ax=ax[1])

plt.subplots_adjust(wspace=0, hspace=0) #removes space between plots
plt.savefig('/Users/aquirk/savedplots/{}_{}.ps'.format(halo, redshift), bbox_inches='tight')
print('/Users/aquirk/savedplots/{}_{}.ps'.format(halo, redshift))
